...
const ReplyForm = styled.form<isCommentProps>`
	display: ${(props) => (props.isComment ? "flex" : "block")};
	padding: 5px ${(props) => (props.isComment ? "0" : "25px")};
`

const ReplyTextArea = styled(StyledTextarea)`
	margin: 0;
`

const ReplyButton = styled(StyledButton)<isCommentProps>`
	...
	return (
		...
		>
			{({
				...
				<ReplyForm isComment={isComment} onSubmit={handleSubmit}>
